...
So my app will help us to make our notes 

# *~Important Point~*
To run this, go to the terminal and run the following commands<br>
# Step 1:
 Create the lib dir and download sqlite-jdbc (example version)
mkdir .\lib
# Step 2:
